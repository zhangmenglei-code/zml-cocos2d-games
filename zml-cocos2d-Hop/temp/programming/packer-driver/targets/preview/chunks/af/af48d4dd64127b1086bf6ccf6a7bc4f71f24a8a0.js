      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property({
        ...
        generateRoad() {
          ...
          for (var _i = 0; _i < this._road.length; _i++) {
            var block = this.spawnBlockByType(this._road[_i]);

            if (block) {
              this.node.addChild(block);
              block.setPosition(_i * (_crd && BLOCK_SIZE === void 0 ? (_reportPossibleCrUseOfBLOCK_SIZE({
                error: Error()
...
//# sourceMappingURL=af48d4dd64127b1086bf6ccf6a7bc4f71f24a8a0.js.map